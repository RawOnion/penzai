package com.example.user.app830.leftmenu_activity;
...
public class touxiang extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(bitmap==null)
                    Toast.makeText(touxiang.this, "请先选择上传照片", Toast.LENGTH_SHORT).show();
                else {
                    new Thread(){
                        @Override
                        public void run() {
                            ...
                            new updataService(bitmap,intent.getStringExtra("name"));
                        }
                    }.start();
                    Toast.makeText(touxiang.this, "上传完毕", Toast.LENGTH_SHORT).show();
                }
            }
        });
